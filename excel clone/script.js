...
$(document).ready(function() {
    ...
    $(".input-cell").click(function(e) {
        if (e.ctrlkey) {
            let [rowId, colId] = gteRowCol(this);
            if (rowId > 1) {
    ...
    $(".input-cell.selected").each(function() {
        ...
        if (cellData[selectedSheet][rowId]) {
            if (cellData[selectedSheet][rowId][colId]) {
                ...
                cellData[selectedSheet][rowId][colId] = {...defaulProperties };
                cellData[selectedSheet][rowId][colId][property] = value;
            }
        } else {
        ...
        if (defaultPossible && (JSON.stringify(cellData[selectedSheet][rowId][colId]) === JSON.stringify(defaulProperties))) {
